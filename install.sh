...
cd /usr/local
git clone https://github.com/mooccat/shadowsocksr.git
git clone https://github.com/mooccat/SSR-Bash-Python.git
...
wget -N --no-check-certificate -O /usr/local/bin/ssr https://raw.githubusercontent.com/mooccat/SSR-Bash-Python/master/ssr
